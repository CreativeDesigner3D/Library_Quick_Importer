...
class QIIMPORT_IMAGE_OT_to_plane(Operator, AddObjectHelper):
    """Create mesh plane(s) from image files with the appropriate aspect ratio"""

    bl_idname = "qiimport_image.to_plane"
    ...
    def import_images(self, context):
        ...
        image = load_image(file_name, file_path, check_existing=True, force_reload=True)
        image_spec = ImageSpec(image, image.size, 1, 1, 1)

        # Create individual planes
        planes = [self.single_image_spec_to_plane(context, image_spec)]
